...
PDIR = os.path.join(ROOT, "projekte", "projekt-5")
PNAME = "Projekt 5"

PAGES = [
    ("index.html", "Überblick"),
    ("02-ideen-sammeln.html", "Ideen sammeln"),
    ("03-grundkonzept-gewaehlt.html", "Grundkonzept gewählt"),
    ("04-erste-zeichnungen.html", "Erste Zeichnungen"),
    ("05-lochplatte.html", "Lochplatte auswählen"),
    ("06-oberteil-unterteil.html", "Oberteil & Unterteil"),
    ("07-erweiterung-gesamtzusammenbau.html", "Erweiterung & Gesamtzusammenbau"),
    ("08-zeichnungssatz-10-april.html", "Zeichnungssatz 10.04."),
    ("09-gesamtzusammenbau-stueckliste.html", "Gesamtzusammenbau & Stückliste"),
    ("10-finale-anpassungen.html", "Finale Anpassungen"),
    ("11-pruefung-gewichtsfehler.html", "Prüfung: Gewichtsfehler"),
    ("12-pruefung-weitere-funde.html", "Prüfung: weitere Funde"),
    ("13-endstand-technische-daten.html", "Endstand & Technische Daten"),
    ("14-fazit-ausblick.html", "Fazit & Ausblick"),
]
