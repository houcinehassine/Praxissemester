...
PDIR = os.path.join(ROOT, "projekte", "projekt-7")
PNAME = "Projekt 7"

PAGES = [
    ("index.html", "Überblick"),
    ("02-aufgabe-rahmen.html", "Aufgabe & Rahmen"),
    ("03-werkzeugbedarf.html", "Werkzeugbedarf"),
    ("04-kostenliste.html", "Bepreiste Werkzeugliste"),
    ("05-5s-ordnung.html", "5S-Ordnung & Zonen"),
    ("06-werkbank-masse.html", "Werkbank: Maße & Ergonomie"),
    ("07-varianten.html", "4 Bauvarianten"),
    ("08-layout-konzepte.html", "4 Layout-Konzepte"),
    ("09-nutzwertanalyse.html", "Nutzwertanalyse & Empfehlung"),
    ("10-wirtschaftlichkeit.html", "Wirtschaftlichkeit & Amortisation"),
    ("11-arbeitssicherheit.html", "Arbeitssicherheit"),
    ("12-umsetzung-audit.html", "Umsetzung, Zeitplan & Audit"),
    ("13-fazit-quellen.html", "Fazit, Quellen & Normen"),
]
