...
PDIR = os.path.join(ROOT, "projekte", "projekt-3")

PAGES = [
    ("index.html", "Überblick"),
    ("02-original-system.html", "Das Original-System"),
    ("03-schwachstellen.html", "Schwachstellen"),
    ("04-architektur.html", "Architektur"),
    ("05-vba-python-portierung.html", "VBA → Python"),
    ("06-datenmodell.html", "Datenmodell & Import"),
    ("07-oberflaeche.html", "Oberfläche"),
    ("08-papierkorb.html", "Papierkorb"),
    ("09-produktionsreife.html", "Produktionsreife"),
    ("10-cloud-migration.html", "Cloud-Migration"),
    ("11-go-live.html", "Go-Live"),
    ("12-code-vertiefung.html", "Code-Vertiefung"),
    ("13-fazit.html", "Fazit & Ausblick"),
]
...
def seiten_kopf(nr, titel, intro):
    ...
    <div class="inner">
      <div class="breadcrumb"><a href="../../index.html">Start</a> &rsaquo; <a href="index.html">Projekt 3</a> &rsaquo; Seite {nr} von {len(PAGES)}</div>
      <h1>{titel}</h1>
