...
PDIR = os.path.join(ROOT, "projekte", "projekt-2")

PAGES = [
    ("index.html", "Überblick"),
    ("02-ausgangslage.html", "Ausgangslage"),
    ("03-design.html", "Design"),
    ("04-kernfunktionen.html", "Kernfunktionen"),
    ("05-artikelgruppe-barcode.html", "Artikelgruppe & Barcode"),
    ("06-filtern-speichern.html", "Filtern & Speichern"),
    ("07-versionsgeschichte.html", "Versionsgeschichte"),
    ("08-aktueller-stand.html", "Aktueller Stand"),
    ("09-material-entnahme.html", "Material-Entnahme & Reste"),
    ("10-fazit.html", "Fazit & Ausblick"),
]
...
def seiten_kopf(nr, titel, intro):
    ...
    <div class="inner">
      <div class="breadcrumb"><a href="../../index.html">Start</a> &rsaquo; <a href="index.html">Projekt 2</a> &rsaquo; Seite {nr} von {len(PAGES)}</div>
      <h1>{titel}</h1>
