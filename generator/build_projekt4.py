...
PDIR = os.path.join(ROOT, "projekte", "projekt-4")
PNAME = "Projekt 4"

PAGES = [
    ("index.html", "Überblick"),
    ("02-grundlagen.html", "Grundlagen"),
    ("03-rahmenbedingungen.html", "Rahmenbedingungen"),
    ("04-werkzeugliste.html", "Werkzeugliste"),
    ("05-konzeptphase-bewertung.html", "Konzeptphase & Bewertung"),
    ("06-gesamtplan-layout.html", "Gesamtplan & Layout"),
    ("07-feste-station-idee-aufbau.html", "Station: Idee & Aufbau"),
    ("08-feste-station-lochwaende-schubladen.html", "Station: Lochwände & Schubladen"),
    ("09-feste-station-reinigung-psa.html", "Station: Reinigung & PSA"),
    ("10-feste-station-material-zusammenbau.html", "Station: Material & Zusammenbau"),
    ("11-sicherheit.html", "Sicherheit"),
    ("12-wirtschaftlichkeit-bezugsquellen.html", "Wirtschaftlichkeit & Einkauf"),
    ("13-fazit-quellen.html", "Fazit & Quellen"),
]
